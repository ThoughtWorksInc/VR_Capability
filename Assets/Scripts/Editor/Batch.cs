...
public class Batch
{
	public static void RunUnitTests()
	{
		...
		vmt.GetVersion_GivenVersionWithBuildNumber_ShouldNotIncrementRevision();
		vmt.GetVersion_GivenVersionWithoutBuildNumber_ShouldNotIncrementRevision();
		vmt.SetBuildNumber_GivenVersionWithBuildNumber_ShouldUpdateRevision();
		vmt.SetBuildVersion_GivenVersionWithoutBuildNumber_ShouldUpdateRevision();
	}
